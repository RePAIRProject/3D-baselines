...
def main(
    ...
    print(f'len(dl_test): {len(dl_test)}')
    ...
    wandb_logger = WandbLogger(
        project="Puzzle-Diff-noPivot-evals",
    ...
    if evaluate:
        ...
        model.save_eval_images = True # by adeela
...
if __name__ == "__main__":
    ...
    ap.add_argument("--dataset", default="RePAIR_assembled_objects_dataset", choices=["RePAIR_assembled_objects_dataset"])
    ...
    ap.add_argument("--adjth", type=float, default=0.01)
