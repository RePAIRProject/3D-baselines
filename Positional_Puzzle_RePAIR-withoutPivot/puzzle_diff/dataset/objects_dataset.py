...
class Objects_Dataset(pyg_data.Dataset):
    ...
    def get(self, idx):
        ...
        denorm_min_vals =  torch.tensor(parts["denorm_min"])
        denorm_max_vals =  torch.tensor(parts["denorm_max"])
        ...
        data = pyg_data.Data(
            ...
            category=category,
            denorm_min_vals = denorm_min_vals,
            denorm_max_vals = denorm_max_vals
        )
        return data
...
if __name__ == "__main__":
    data_dict = dict(
        data_dir="datasets/RePAIR_assembled_objects_dataset",
        data_fn="train",
        data_keys=("part_ids",),
        category="all",  # all
        num_points=1000,
