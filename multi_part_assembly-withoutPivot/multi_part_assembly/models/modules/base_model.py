...
class BaseModel(pl.LightningModule):
    ...
    def _calc_metrics(self, data_dict, out_dict, gt_trans, gt_rot):
        ...
        min_vals = data_dict['denorm_min']
        max_vals = data_dict['denorm_max']
        pcs_paths = data_dict['pcs_paths']

        metric_dict['part_acc'], metric_dict['precision'], metric_dict['recall'], metric_dict['f1'], metric_dict['Qpos'] = calc_part_acc(part_pcs, pred_trans, gt_trans,
                                                pred_rot, gt_rot, valids, min_vals,  max_vals)
        # semantic assembly
